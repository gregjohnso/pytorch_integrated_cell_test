...
parser.add_argument('--dataProvider_kwargs', help='model **kwargs formatted in json format', default={}, type=json.loads)
...
dp = model_utils.load_data_provider(opt.data_save_path, opt.imdir, opt.dataProvider, opt.dataProvider_kwargs)
